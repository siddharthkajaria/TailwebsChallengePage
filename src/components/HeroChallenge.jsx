    ...
    >
      ...
      <div className="relative max-w-[900px] text-center">
        <div className="fade-up inline-flex items-center gap-2 bg-white/[0.06] border border-white/10 rounded-full py-[7px] px-[18px] pl-3 text-[0.78rem] font-semibold text-tw-accent uppercase tracking-[0.05em] mb-8 backdrop-blur-sm">
          ...
          Live Challenge — Only {SLOTS_LEFT} Slots Left This Week
        </div>
        ...
        <h1 className="fade-up delay-1 font-heading text-[clamp(2.6rem,6.5vw,4.5rem)] font-extrabold leading-[1.05] tracking-[-0.035em] mb-6 text-tw-text-inv" id="hero-heading">
          Take the{" "}
          <span className="inline-block bg-gradient-to-br from-[#E63946] via-[#FF6B6B] to-[#F5A623] bg-clip-text text-transparent">72-Hour Challenge.</span>
          <br />Watch us build your idea — <span className="font-serif italic font-normal">live.</span>
        </h1>
        ...
        <p className="fade-up delay-2 text-[clamp(1.05rem,2vw,1.2rem)] text-tw-muted-light leading-[1.7] max-w-[620px] mx-auto mb-11 font-normal">
          Submit your idea today. In 72 hours, <strong className="text-tw-text-inv font-semibold">Tailwebs' AI-driven team</strong> ships you a working product — at <strong className="text-tw-text-inv font-semibold">1/10th the traditional cost.</strong> No retainers, no surprises, just proof.
        </p>
